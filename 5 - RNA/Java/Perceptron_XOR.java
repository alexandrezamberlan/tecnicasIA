...
public class Perceptron_XOR {//RNA mais simples... feedforward .... uma camada... supervisionado
	...
	Perceptron_XOR() {
        ...
        //1 e 0 = 1 - Segundo Valor
        //0 e 1 = 1 - Terceiro Valor
        //1 e 1 = 0 - Quarto Valor
		...
		this.matrizAprendizado[3][2] = 0; // valor esperado
    ...
    void testar() { //colocar em prática o modelo rna treinado para reconhecer
        ...
        System.out.println(" Teste 1 para 0 XOR 0 " + executar(0, 0));
 
        System.out.println(" Teste 2 para 0 XOR 1 " + executar(0, 1));
 
        System.out.println(" Teste 3 para 1 XOR 0 " + executar(1, 0));
 
        System.out.println(" Teste 4 para 1 XOR 1 " + executar(1, 1));
 
    }
 
    public static void main(String[] arguments) {
 
        Perceptron_XOR perceptron = new Perceptron_XOR();
